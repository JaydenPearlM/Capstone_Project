                            ...
                            <div className="spending-compare">
                                ...
                                {(() => {
                                    ...
                                    const getMonthTotal = (offset) => {
                                        ...
                                        const startStr = `${range.start.getFullYear()}-${pad(
                                            range.start.getMonth() + 1
                                        )}-${pad(range.start.getDate())}`;
                                        const endStr = `${range.end.getFullYear()}-${pad(
                                            range.end.getMonth() + 1
                                        )}-${pad(range.end.getDate())}`;
                                    ...
                                    // Get totals for last 2 months + current month
